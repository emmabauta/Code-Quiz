...
![Start Screen](Homework-Code-Quiz\Assets\Screenshot (12).png)
...
![Multiple Choice Question](Homework-Code-Quiz\Assets\Screenshot (13).png)

After answering all of the questions, input your name to have your score recorded on the highscores board!
![Highscore screen](Homework-Code-Quiz\Assets\Screenshot (14).png)